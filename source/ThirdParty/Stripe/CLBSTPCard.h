 ...
 */
typedef NS_ENUM(NSInteger, CLBSTPCardFundingType) {
    CLBSTPCardFundingTypeDebit,
    CLBSTPCardFundingTypeCredit,
    CLBSTPCardFundingTypePrepaid,
    CLBSTPCardFundingTypeOther,
};
 ...
 */
@interface CLBSTPCard : CLBSTPCardParams
 ...
 */
@property (nonatomic, readonly) CLBSTPCardFundingType funding;
...
#define DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS __attribute__((deprecated("For collecting your users' credit card details, you should use an CLBSTPCardParams object instead of an CLBSTPCard.")))

@property (nonatomic, copy, nullable) NSString *number DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
@property (nonatomic, copy, nullable) NSString *cvc DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
- (void)setExpMonth:(NSUInteger)expMonth DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
- (void)setExpYear:(NSUInteger)expYear DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
- (void)setName:(nullable NSString *)name DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
- (void)setAddressLine1:(nullable NSString *)addressLine1 DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
- (void)setAddressLine2:(nullable NSString *)addressLine2 DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
- (void)setAddressCity:(nullable NSString *)addressCity DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
- (void)setAddressState:(nullable NSString *)addressState DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
- (void)setAddressZip:(nullable NSString *)addressZip DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
- (void)setAddressCountry:(nullable NSString *)addressCountry DEPRECATED_IN_FAVOR_OF_CLBSTPCARDPARAMS;
