...
typedef void (^CLBAuthenticationCompletionBlock)(NSString *jwt);
 ...
 */
@protocol CLBAuthenticationDelegate <NSObject>
 ...
 */
- (void)onInvalidToken:(NSError *) error handler:(CLBAuthenticationCompletionBlock)completionHandler;
